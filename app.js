...
// LocalStorage Keys
const STORAGE_KEYS = {
    ANSWERS: 'makemehealthy_answers',
    HEALTH_PLAN: 'makemehealthy_plan'
};
...
function downloadPDF() {
    ...
    doc.setFontSize(22);
    doc.setFont('helvetica', 'bold');
    doc.text('Make Me Healthy', margin, 18);
    doc.setFontSize(12);
    ...
    doc.text('Generated by Make Me Healthy - makemehealthy.xyz', margin, 285);
    
    // Save the PDF
    doc.save('makemehealthy-plan.pdf');
}
